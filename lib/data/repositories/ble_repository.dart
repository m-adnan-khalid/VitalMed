...
class BLERepositoryImpl implements BLERepository {
  ...
  BLERepositoryImpl(this._bleService, this._apiService);
  ...
  Future<void> initialize() async {
    try {
      ...
      AppLogger.info('BLE Repository initialized with real-time measurement processing');
    } catch (e) {
      AppLogger.error('Failed to initialize BLE Repository', e);
  ...
  Future<void> dispose() async {
    try {
      ...
      AppLogger.info('BLE Repository disposed');
    } catch (e) {
      AppLogger.error('Error disposing BLE Repository', e);
    }
  }
}
